...
function isNum(x: any): boolean{ return typeof x === "number"}
...
function compare2(left: any[], right: any[]): val
{
  ...
  if (left.length < right.length) return val.true
  return val.dnd
}
