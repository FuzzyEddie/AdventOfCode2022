...
const filePath = "C:/CodingProjects/AdventOfCode2022/08/testinput.txt";
            ...
            switch (dirs[x]) {
                ...
                case 1:
                    if (origin[0] == this.trees[0].length - 1)
                        return true;
                    for (let y = 0; y < this.trees[0].length; y++) {
...
for (let x = 0; x < orchard.trees.length; x++) {
    for (let y = 0; x < orchard.trees[x].length; x++) {
